...
import { WalletPersistenceModule } from './modules/wallet/infrastructure/persistence/wallet-persistence.module.js';

import { WageringPersistenceModule } from './modules/wagering/infrastructure/persistence/wagering-persistence.module.js';

import { DatabaseTransactionModule } from './shared/infrastructure/database/database-transaction.module.js';

import { MessagingModule } from './modules/messaging/messaging.module.js';
import { ApiModule } from './shared/presentation/http/api.module.js';
import { ObservabilityModule } from './shared/infrastructure/observability/observability.module.js';
import { OperationsController } from './shared/presentation/http/operations.controller.js';
